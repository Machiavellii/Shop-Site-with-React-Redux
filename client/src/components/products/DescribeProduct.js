          ...
          <div className="row" key={prod._id}>
            ...
            <div className="col-md-7">
              ...
              <p className="mb-4">
                ...
                eligendi quidem velit accusamus voluptatum vero delectus
                voluptate obcaecati harum similique! Lorem ipsum dolor sit amet
                consectetur adipisicing elit. Mollitia quia necessitatibus
                impedit tempora voluptas modi tempore a neque non officia!
              </p>
              <div className="mb-2">
              ...
              <div className="mb-4">
                <span className="first-span">Kolicina:</span> <span>1</span>
              </div>
